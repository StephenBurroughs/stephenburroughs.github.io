...
>Instead, rotating a given operation should apply the rotation to the object in quesstion, along with the positioning of its connected ports, but have **no** effect on other operations.
